...
function sort(countries: projectListModel[], column: SortColumn, direction: string): projectListModel[] {
  if (direction === '' || column === '') {
    return countries;
  } else {
...
function matches(country: projectListModel, term: string, pipe: PipeTransform) {
...
export class ProfileService {
  ...
  private _countries$ = new BehaviorSubject<projectListModel[]>([]);
